...
public class JAnimatedButton extends JButton {
	...
	private ButtonStyle style = ButtonStyle.HOME_SIDEBAR;
	private final ButtonColor currentStyle;
	private int round = 5;

	public JAnimatedButton() {
		this(null, ButtonStyle.HOME_SIDEBAR);
	}

	public JAnimatedButton(String name) {
		this(name, ButtonStyle.HOME_SIDEBAR);
	}

	public JAnimatedButton(String name, ButtonStyle style) {
		super(name);
		this.currentStyle = new ButtonColor(style);
		...
		this.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent me) {
				animationHover.start(currentStyle.backgroundHover, getStyle().getBackgroundHover());
			}

			@Override
			public void mouseExited(MouseEvent me) {
				animationHover.start(currentStyle.backgroundHover, getStyle().getBackground());
			}

			@Override
			public void mousePressed(MouseEvent me) {
				animationPress.start(currentStyle.background, getStyle().getBackgroundPress());
			}

			@Override
			public void mouseReleased(MouseEvent me) {
				animationPress.start(currentStyle.background, getStyle().getBackground());
			}
	...
	protected static class ButtonColor {
	...
	private static class AnimationStyle {
